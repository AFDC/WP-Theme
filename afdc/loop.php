...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<div id="nav-above" class="navigation">
					<div class="nav-previous"><?php previous_posts_link( __( '<span class="meta-nav">&laquo;</span> Newer Entries', 'twentyten' ) ); ?></div>
					<div class="nav-next"><?php next_posts_link( __( 'Older Entries <span class="meta-nav">&raquo;</span>', 'twentyten' ) ); ?></div>
	</div><!-- #nav-above -->
<?php endif; ?>
